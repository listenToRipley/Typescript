...
`abstract` - If you use this keyword on a class, you cannot instantiate it by itself. This should be used as a way to create requirements to be places on extended classes, such as methods or constructor elements. Think of it as inheriting rules. 
